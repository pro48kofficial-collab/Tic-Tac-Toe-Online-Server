...
(function(){
  var start=Date.now(), duration=1400, bar=document.getElementById('bar'), percent=document.getElementById('percent'), loading=document.getElementById('loading'), app=document.getElementById('app');
  function tick(){
    ...
    if(n>=100){
      ...
      setTimeout(function(){ if(loading.parentNode) loading.parentNode.removeChild(loading); if(app) app.hidden=false; },220);
